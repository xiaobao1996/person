<template>
  <div class="app-container">
   ...
   <!--   <div class="config-item" style="margin-bottom: 90px">
        ...
        <div class="config-info">说明：此添加方式可以依据 <span style="color: #02B2B5">选择的身份</span>,自动找到关联的人员，进行推送</div>
        <div class="config-container">
          ...
          <div class="cc-container">
            <button class="cc-container-item" v-for="(item, index) in checkedRoleTypeList" :key="index" >
              {{item.name}}
              &lt;!&ndash;<i class="el-icon-close cc-close"> </i>&ndash;&gt;
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      this.getStaffList()
      this.getStaffReportConfig()
      // this.getStaffReportIdentifyList()
      },
    mounted() {
    }
  }
